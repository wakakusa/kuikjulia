 ...
 * glade:none
************************************************************************************************************/
G_MODULE_EXPORT void cb_Parallel_function3_for_terminal(GtkWidget *widget, gpointer data)
{
  
  gchar *script;
  g_free(script);
  
  script=g_strconcat("@everywhere \n",NULL);
 ...
 * glade:none
************************************************************************************************************/
G_MODULE_EXPORT void cb_Parallel_function3_for_editor(GtkWidget *widget, gpointer data)
{
