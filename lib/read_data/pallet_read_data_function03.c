 ...
 * 
 * 
 * glade:Read_JLD_filechooserdialog
 **********************************************************************************************/
void create_Read_JLD_filechooserdialog(StructPalletReadWriteData *struct_widget,char UI_FILE[PATH_LENGTH],char Window_name[512])
{
  GtkBuilder *builder;
  GError* error = NULL;
 ...
 * glade:none
 **********************************************************************************************/
G_MODULE_EXPORT void create_ReadJLD_filechooserdialog_OK (GtkWidget *widget,gpointer data  )
{
